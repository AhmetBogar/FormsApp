namespace FormsApp.Models
{
	public class Repository
	{
		...
		static Repository()
		{
			...
			_products.Add(new Product { ProductId=1,Name="Iphone 14",Price=40000,IsActive=false,Image="1.jpg",CategoryId=2});
			_products.Add(new Product { ProductId=2,Name="Iphone 15",Price=50000,IsActive=true,Image="2.jpg",CategoryId=2});
			_products.Add(new Product { ProductId=3,Name="Iphone 16",Price=60000,IsActive=false,Image="3.jpg",CategoryId=2});
