namespace FormsApp.Models
{
	public class Repository
	{
		...
		static Repository()
		{
			...
			_products.Add(new Product { ProductId=5,Name="Macbook 14",Price=80000,IsActive=true,Image="5.jpg",CategoryId=2});
			_products.Add(new Product { ProductId=6,Name= "Macbook 15", Price=95000,IsActive=true,Image="6.jpg",CategoryId=2});
